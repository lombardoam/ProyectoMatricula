   ...
   <table class="table table-bordered">
      ...
      <tbody >
        <?php
            ...
            $sql = "SELECT cursos.id_curso, cursos.codigo_curso, cursos.nombre_curso, cursos.uv, cursos.horas_practicas, cursos.horas_teoricas, cursos.laboratorio, planes_estudio.nombre_plan, cursos.periodo FROM cursos INNER JOIN planes_estudio WHERE cursos.id_plan_estudio = planes_estudio.id_plan_estudio AND cursos.periodo='1' ORDER BY id_curso;;";
