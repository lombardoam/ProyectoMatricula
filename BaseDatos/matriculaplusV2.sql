...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-08-2015 a las 10:15:06
...
ALTER TABLE `requisitos_curso`
  ADD CONSTRAINT `fk_cursos_requisitos` FOREIGN KEY (`id_curso_real`) REFERENCES `cursos` (`id_curso`) ON DELETE NO ACTION ON UPDATE NO ACTION;
