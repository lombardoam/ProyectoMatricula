...
--
-- Servidor: localhost
-- Tiempo de generación: 25-08-2015 a las 06:06:49
...
(7, 'DIS101', 'DiseÃ±o ArquitectÃ³nico II', 4, 50, 10, 0, 3, 3),
(8, 'DER101', 'Derecho Constitucional', 4, 50, 0, 0, 4, 7),
(9, 'DER102', 'Derecho Penal', 4, 0, 50, 0, 4, 8),
(10, 'ARQ1001', 'DiseÃ±o ArquitectÃ³nico I', 4, 50, 10, 0, 3, 2),
(11, 'MAT5001', 'EstÃ¡tica', 4, 25, 24, 0, 2, 8),
(12, 'DER402', 'Derecho Digital', 4, 0, 50, 0, 4, 12);
...
(7, 'JK', 'Yury', 'Euceda', 'M', 92292929, 'jury@gmail.com', 'IIT', 1, 20150006),
...
(12, 'PG1', 'Pedro', 'Gallardo', 'M', 23654787, 'pg@gmail.com', 'INGC', 1, 20145623),
(13, 'CLF', 'Claudia', 'Flores', 'F', 45151225, 'clau@gmail.com', 'DER', 2, 20124582),
(14, 'MF', 'Mario', 'Flores', 'M', 545454, 'ma@ujcv.edu.hn', 'ARQ', 1, 20120123),
(15, 'EDU', 'Edgardo', 'Ulloa', 'M', 544545, 'ulloa@gmail.com', 'IIT', 1, 20102310),
(16, 'VER', 'VerÃ³nica', 'Midence', 'F', 54545, 'vero@ujcv.edu.hn', 'DER', 1, 20142010),
(17, 'LMEJ', 'LucÃ­a', 'MenjÃ­var', 'F', 45515, 'lucy@ujcv.edu.hn', 'DER', 1, 20142520),
(18, 'COC', 'Carmen', 'CabaÃ±as', 'F', 4514511, 'carmca@ujcv.edu.hn', 'INGC', 1, 20123012),
(19, 'LINU', 'Litza', 'NÃºÃ±ez', 'F', 845120, 'litza@ujcv.edu.hn', 'INGC', 1, 20123042),
(20, 'JNF', 'Janelly', 'Flores', 'F', 4512535, 'jane@ujcv.edu.hn', 'ARQ', 1, 20132012);
...
INSERT INTO `historiales_academicos` (`id_historial`, `codigo_historial`, `num_cuenta`, `id_curso`, `id_evaluacion`, `estado`) VALUES
...
INSERT INTO `prematriculas` (`id_prematricula`, `id_estudiante`, `id_programacion`, `estatus_curso`) VALUES
(1, 3, 1, 'Activo'),
(2, 3, 2, 'Activo');
...
(3, 'PROG3', 1, 4, 1, 'A', '15:50', '19:40', 'Ma', 17, 9, 'Activo'),
(4, 'PROG4', 1, 5, 2, 'B', '9:50', '12:40', 'L-Mi-V', 12, 4, 'Activo'),
(5, 'PROGARQ1', 1, 7, 3, 'A', '9:50', '11:40', 'L-Mi-V', 3, 4, 'Activo'),
(6, 'PROGDER1', 1, 8, 4, 'A', '15:50', '17:40', 'L-Mi-V', 13, 6, 'Activo'),
(7, 'PROGDER2', 1, 9, 4, 'B', '16:50', '18:40', 'Ma-J', 13, 6, 'Activo'),
(8, 'PROG5', 1, 5, 2, 'A', '6:50', '8:40', 'L-Mi-V', 18, 4, 'Activo'),
(9, 'PROGARQ2', 1, 6, 3, 'A', '10:50', '13:40', 'Ma', 12, 8, 'Activo'),
(10, 'PROGARQ2', 1, 10, 3, 'A', '17:50', '19:40', 'Ma-J', 3, 6, 'Activo'),
(11, 'PROGCIV1', 1, 11, 2, 'B', '15:50', '16:40', 'L-Mi-V', 20, 5, 'Activo'),
(12, 'PROGDER3', 1, 12, 4, 'A', '17:50', '19:40', 'Ma-J', 19, 3, 'Activo'),
(13, '', 1, 3, 1, 'c', '79', '8', 'hkj', 16, 6, 'Activo');
...
CREATE TABLE IF NOT EXISTS `requisitos_curso` (
  ...
  `id_curso` int(11) NOT NULL,
  `id_requisito1` int(11) DEFAULT NULL,
  `id_requisito2` int(11) DEFAULT NULL,
  `id_requisito3` int(11) DEFAULT NULL
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `requisitos_curso`
--

INSERT INTO `requisitos_curso` (`id_requisito`, `codigo_requisito`, `id_plan_estudio`, `id_curso`, `id_requisito1`, `id_requisito2`, `id_requisito3`) VALUES
(1, 'jkh', 1, 4, 3, NULL, NULL),
(2, 'jkh', 1, 3, 2, 1, NULL);
...
ALTER TABLE `historiales_academicos`
  ...
  ADD KEY `num_cuenta_idx` (`num_cuenta`),
...
ALTER TABLE `requisitos_curso`
  ...
  ADD KEY `codigo_curso_idx` (`id_plan_estudio`);
...
--
ALTER TABLE `cuotas_estudiante`
  MODIFY `id_cuotas` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `planes_estudio`
  MODIFY `id_plan_estudio` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT de la tabla `prematriculas`
--
ALTER TABLE `prematriculas`
  MODIFY `id_prematricula` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `tipos_usuarios`
  MODIFY `tipo_usuario` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
...
--
ALTER TABLE `requisitos_curso`
  ADD CONSTRAINT `fk_cursos_requisitos` FOREIGN KEY (`id_plan_estudio`) REFERENCES `cursos` (`id_curso`) ON DELETE NO ACTION ON UPDATE NO ACTION;
