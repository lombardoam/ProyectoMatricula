...
--
-- Servidor: localhost
-- Tiempo de generación: 16-08-2015 a las 07:07:26
...
INSERT INTO `asistencia` (`id_programacion`, `id_estudiante`, `fecha`, `estado`, `id_periodo`, `id_asistencia`) VALUES
(1, 5, '2015-08-14', 'Ausente', 1, 80),
(1, 5, '2015-08-14', 'Ausente', 1, 81),
(2, 4, '2015-08-14', 'Asistio', 1, 82),
(2, 1, '2015-08-14', 'Ausente', 1, 83),
(2, 4, '2015-08-14', 'Asistio', 1, 84),
(2, 1, '2015-08-14', 'Asistio', 1, 85),
(2, 4, '2015-08-14', 'Asistio', 1, 86),
(2, 1, '2015-08-14', 'Asistio', 1, 87),
(2, 4, '2015-08-14', 'Asistio', 1, 88),
(2, 1, '2015-08-14', 'Asistio', 1, 89),
(2, 4, '2015-08-14', 'Asistio', 1, 90),
(2, 1, '2015-08-14', 'Ausente', 1, 91),
(2, 4, '2015-08-14', 'Asistio', 1, 92),
(2, 1, '2015-08-14', 'Ausente', 1, 93),
(2, 4, '2015-08-14', 'Ausente', 1, 94),
(2, 1, '2015-08-14', 'Asistio', 1, 95),
(2, 4, '2015-08-14', 'Ausente', 1, 96),
(2, 1, '2015-08-14', 'Asistio', 1, 97),
(2, 4, '2015-08-14', 'Ausente', 1, 98),
(2, 1, '2015-08-14', 'Asistio', 1, 99),
(2, 4, '2015-08-14', 'Ausente', 1, 100),
(2, 1, '2015-08-14', 'Asistio', 1, 101),
(2, 4, '2015-08-14', 'Ausente', 1, 102),
(2, 1, '2015-08-14', 'Ausente', 1, 103),
(1, 5, '2015-08-14', 'Ausente', 1, 104),
(1, 5, '2015-08-16', 'Justificado', 1, 105),
(2, 4, '2015-08-16', 'Justificado', 1, 106),
(2, 1, '2015-08-16', 'Justificado', 1, 107);
...
(1, 'IIT4011', 'Seguridad de la Informacion', 4, 0, 60, 0, 1, 10),
(2, 'IIT3032', 'Ingenieria de Software I', 3, 0, 48, 0, 1, 9),
...
(8, 'DER101', 'Derecho Constitucional', 4, 50, 50, 0, 4, 7),
...
(5, 20153002, 'Katherine', 'Marquez', 'Primer ingreso', 'Tegucigalpa', '1991-09-23', 'Soltera', 'El Hatillo', 22336655, '', 0, '2013-01-15 06:00:00', 3, 1000);
...
INSERT INTO `faltas` (`horas_teoricas`, `faltas`) VALUES
(48, 12),
(50, 16),
(60, 10);
...
(2, 'PROG2', 1, 2, 1, 'A', '12:50', '14:40', 'Ma-J', 6, 4, 'Activo'),
...
(11, 'pablo', 'marmol', 't', 't', 3, 22222, 21);
...
--
ALTER TABLE `faltas`
  ADD PRIMARY KEY (`horas_teoricas`);
...
--
ALTER TABLE `asistencia`
  MODIFY `id_asistencia` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=108;
--
...
--
ALTER TABLE `prematriculas`
  MODIFY `id_prematricula` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `programacion_cursos`
--
ALTER TABLE `programacion_cursos`
  MODIFY `id_programacion` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
