...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-08-2015 a las 12:06:14
...
INSERT INTO `matriculas` (`id_matricula`, `num_cuenta`, `id_programacion`) VALUES
(1, 20011025, 2),
(2, 20131037, 7);
...
(13, 'PROGIIT5', 1, 3, 1, 'A', '15:50', '16:40', 'L-Mi-V', 16, 6, 'Activo');
...
CREATE TABLE IF NOT EXISTS `requisitos_curso` (
  ...
  KEY `codigo_curso_idx` (`id_plan_estudio`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;
