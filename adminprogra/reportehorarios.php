   ...
   <table class="table table-bordered">
      ...
      <tbody >
        <?php
            ...
            $sql = "SELECT programacion_cursos.id_programacion, programacion_cursos.codigo_prog_curso, periodos_academicos.codigo_periodo, cursos.nombre_curso, planes_estudio.nombre_plan, programacion_cursos.seccion, programacion_cursos.hora_inicio, programacion_cursos.hora_termina, programacion_cursos.dias, empleados.nombres, aulas.codigo_aula, programacion_cursos.estatus_curso FROM programacion_cursos INNER JOIN periodos_academicos INNER JOIN cursos INNER JOIN planes_estudio INNER JOIN empleados INNER JOIN aulas WHERE programacion_cursos.id_periodo = periodos_academicos.id_periodo AND programacion_cursos.id_curso = cursos.id_curso AND programacion_cursos.id_plan_estudio = planes_estudio.id_plan_estudio AND programacion_cursos.id_empleado = empleados.id_empleado AND programacion_cursos.id_aula = aulas.id_aula AND planes_estudio.id_plan_estudio='" . ($_SESSION['id_plan_estudio']) . "' ORDER BY id_programacion;;";
