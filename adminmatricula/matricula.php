...
$qtipo = mysqli_query($conexion, $qtipo);
 while($lineatipo = mysqli_fetch_assoc($qtipo)){
  ...
  if ($lineatipo['tipo_estudiante']='Primer Ingreso'){
            ...
            $sql = "SELECT programacion_cursos.id_programacion, programacion_cursos.codigo_prog_curso, cursos.nombre_curso, planes_estudio.nombre_plan, programacion_cursos.dias, programacion_cursos.seccion, programacion_cursos.hora_inicio, programacion_cursos.hora_termina,  empleados.nombres, aulas.codigo_aula FROM programacion_cursos INNER JOIN cursos INNER JOIN planes_estudio INNER JOIN empleados INNER JOIN aulas INNER JOIN estudiantes WHERE programacion_cursos.id_curso = cursos.id_curso AND programacion_cursos.id_plan_estudio = planes_estudio.id_plan_estudio AND programacion_cursos.id_empleado = empleados.id_empleado AND programacion_cursos.id_aula = aulas.id_aula AND programacion_cursos.id_plan_estudio='" . $lineaplan['id_plan_estudio'] . "' AND estudiantes.num_cuenta='" . $_GET['numerocuenta'] . "' AND estudiantes.tipo_estudiante='" . $lineatipo['tipo_estudiante'] . " AND programacion_cursos.estatus_curso='Activo' ORDER BY id_programacion;;";
