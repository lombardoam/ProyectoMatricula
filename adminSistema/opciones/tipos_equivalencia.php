   ...
   <div class="principal">
           <nav>
                <ul>
                    ...
                    <li class="active"><a href="avanzado.php"><span><i class="fa fa-cog fa-2x"></i></span>AVANZADO</a>
                    <ul>
       ...
       <div class="panel">
          <center><a href="salones.php">PANEL DE TIPOS DE EQUIVALENCIA</a></center>
       </div>

       <center><div class="tablas">
        <div id="PersonTableContainer18"></div><br><br>
       </div></center>
