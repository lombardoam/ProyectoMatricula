   ...
   <div class="principal">
           <nav>
                <ul>
                    ...
                    <li class="active"><a href="cursos.php"><span><i class="fa fa-calendar fa-2x"></i></span>CURSOS</a>
                    <ul>
       ...
       <div class="panel">
          <center><a href="edificios.php">PANEL DE CONTENIDO DE CURSOS</a></center>
       </div>

       <center><div class="tablas">
        <div id="PersonTableContainer7"></div><br><br>
       </div></center>
