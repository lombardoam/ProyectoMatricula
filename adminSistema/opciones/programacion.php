   ...
   <div class="principal">
           <nav>
                <ul>
                    ...
                    <li class="active"><a href="cursos.php"><span><i class="fa fa-calendar fa-2x"></i></span>CURSOS</a></li>
       ...
       <div class="panel">
          <center><a href="edificios.php">PANEL DE PROGRAMACIÓN DE CURSOS</a></center>
       </div>
