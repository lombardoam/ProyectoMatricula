...
$result = mysqli_query($conexion, "INSERT INTO programacion_cursos(codigo_prog_curso, id_periodo, codigo_curso, seccion, hora_inicio, hora_termina, dias, id_empleado, id_aula, estatus_curso) VALUES('" . $_POST["codigo_prog_curso"] . "', " . $_POST["id_periodo"] . ", '" . $_POST["codigo_curso"] . "', '" . $_POST["hora_inicio"] . "', '" . $_POST["hora_termina"] . "', '" . $_POST["dias"] . "', " . $_POST["id_empleado"] . "," . $_POST["id_aula"] . ", '" . $_POST["estatus_curso"] . "');");
